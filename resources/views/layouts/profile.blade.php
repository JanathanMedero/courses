...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="sidenav-collapse-main">
				...
				<ul class="navbar-nav">
					...
					<a class="nav-link " href="{{ route('dashboard', Auth::user()->slug) }}">
					...
					<li class="nav-item">
						<a class="nav-link " href="{{ route('moderators.index') }}">
							<i class="fas fa-user-shield text-orange"></i> Moderadores
						</a>
					</li>
					<li class="nav-item">
	...
	<div class="main-content">
		<div class="row">
			<nav class="navbar navbar-top navbar-expand-md navbar-red" id="navbar-main">
				...
				<div class="row">
					<div class="col-md-12 d-flex align-items-center justify-content-end">
						<div class="copyright text-center text-xl-left text-muted">
							&copy; 2020 <a href="#" class="font-weight-bold ml-1" target="_blank">Janathan Medero With</a> ❤️
						</div>
					</div>
				</div>
			</footer>
